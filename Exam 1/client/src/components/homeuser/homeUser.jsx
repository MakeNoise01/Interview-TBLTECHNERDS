...
const HomeUser = () => {
    ...
    const deleteContact = (id) => {
      axios.delete(`http://localhost:3005/remove/${user.id}/${id}`)
    ...
    return (
        <div className='principalContacts'>
            <div className='myContacts'>
                ...
                /> : <span style={{color: "white", marginBottom: '16vw', marginTop: '4vw', fontSize: '7vw'}}>You don't have contacts yet</span>}
            </div>
